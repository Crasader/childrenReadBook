...
//}
//
//vector<map<string, YYXStruct>> CityTableView::loadData(int bookid, int memberID)
//{
//	m_bookid = bookid;
//	m_memberID = memberID;
//	m_data.clear();
...
//}
//
//vector<map<string, YYXStruct>> CityTableView::loadData()
//{
//	m_bookid = bookid;
//	m_data.clear();
//	int count = YYXStruct::getMapInt64(App::GetInstance()->myData, StringUtils::format("comment_bookid=%d", bookid), 0);
...
//		auto teext = Label::create(context, "wryh.TTF", 22 * 2);
...
//}
//
//void CityTableView::loadData(map<string, YYXStruct> dat)
//{
//	m_data.push_back(dat);
//}
//
//Layout* CityTableView::createItem(map<string, YYXStruct>  data, int idx)
//{
...
//	//文字
//	auto context = YYXStruct::getMapString(data, "context", "");
//	auto teext = Label::create("", "wryh.TTF", 22*2);
//	teext->setTag(4);
...
//}
//
//void CityTableView::reuseItem(TableViewCell*item, map<string, YYXStruct>  data, int idx)
//{
...
//}
//
//void CityTableView::playVoiceFrameAnimation(Sprite* vsp)
//{
...
//}
//
//void CityTableView::showAnimationEnd(Sprite* sp)
//{
...
//
////处理自己发布的评论
//void CityTableView::handleYourOwnComments(TableView* table, TableViewCell* cell)
//{
...
//
////声音播放完毕或者终止时 需要处理的事件
//void CityTableView::soundPlayCompletes()
//{
...
//
////处理别人发布的评论
//void CityTableView::handleOtherComments(TableView* table, TableViewCell* cell)
//{
//	auto index = cell->getIdx();
//	auto data = m_data[index];
//	//只处理语音item
...
//}
//
//void CityTableView::stopAllAnimation()//提供给外部的函数
//{
//	YYXLayer::sendNotify(TAG_STOPCOMMENT_SOUND_ANIMATION);
//}
//
