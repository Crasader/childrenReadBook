...
public final class PublicCons {
    ...
    public static final class DBCons {
        ...
        public static final String TB_TASK_BOOKID = "bookId";
        ...
        public static final String TB_TASK_ISFINISH = "isfinish";

        public static final String TB_THREAD = "thread_info";
        public static final String TB_THREAD_BOOKID = "bookId";
        ...
        public static final String TB_TASK_SQL_CREATE = "CREATE TABLE " +
                ...
                PublicCons.DBCons.TB_TASK_BOOKID + " CHAR, " +
